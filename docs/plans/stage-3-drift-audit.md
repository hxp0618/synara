...
4. In progress: Workspace/Git/Checkpoint DDL, public/private HTTPS Clone/Fetch, Git Credential, state reporting, cross-process locked cache plus private relative worktree generations, Git-reference/Patch/Snapshot capture/restore and Checkpoint/Artifact retention are implemented; add SSH Credential delivery, physical Workspace cleanup lifecycle and real multi-Worker/Target acceptance.
