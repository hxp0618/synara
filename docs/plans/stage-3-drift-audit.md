...
Baseline: `codex/saas-tenancy-user` after clean commit `d3af9380`, including the deterministic managed Docker
immutable Worker Release rollout gate with Busy baseline Worker preservation. The consolidated real Codex/Claude Local product and controlled-failure
