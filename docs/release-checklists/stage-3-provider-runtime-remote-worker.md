...
真实 Provider、remote Target、multi-node、load、生产时长或生产 Retention。
...
- [ ] 多 Turn 长 Session、多 Provider 并发、长日志、Checkpoint/Resume 和 Retention soak 完成。（`6e866a30`
      ...
      deterministic Local active-Execution Retention fencing 与 post-terminal physical cleanup mechanics。）
