...
| Kubernetes fixture                                     | `6b71703f` OrbStack 22 pass/1 unsupported；`2763ebd3` Kind 13/13 | approved Context、API/TLS override、Eviction、Network、Canary、restart 与 exact cleanup 已验；Node Drain 未授权，仍不是真实 Provider pass gate                           |
