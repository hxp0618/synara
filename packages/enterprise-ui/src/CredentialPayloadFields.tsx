import type { CredentialFormKind, CredentialPayloadDraft } from "./credentialPayloadForm";
...
export function CredentialPayloadFields(props: {
  ...
  const { FormField: ControlPlaneFormField, Input, Textarea } = useEnterpriseUiHost();
...
function ManagedProviderFields(props: {
  ...
  const { FormField: ControlPlaneFormField, Input } = useEnterpriseUiHost();
  return (
    <>
      <ControlPlaneFormField
