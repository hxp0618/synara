...
func runPowerShell(request psRequest) (*psResponse, error) {
	...
	tempDir, err := os.MkdirTemp("", "wandy-windows-*")
	if err != nil {
		return nil, err
	}
