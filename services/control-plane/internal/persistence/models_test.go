...
func TestModelsHaveValidGormSchemas(t *testing.T) {
	models := []any{
		...
		&AgentExecution{}, &ExecutionSchedulingDecision{}, &ExecutionSchedulingCandidate{}, &ExecutionRuntimeIsolationDecision{}, &WorkerLease{}, &WorkerRequestReceipt{}, &APIIdempotencyKey{}, &ExecutionInteraction{}, &OutboxMessage{},
	}
