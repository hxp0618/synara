...
func TestModelsHaveValidGormSchemas(t *testing.T) {
	models := []any{
		...
		&AgentExecution{}, &ExecutionSchedulingDecision{}, &ExecutionSchedulingCandidate{}, &WorkerLease{}, &WorkerRequestReceipt{}, &APIIdempotencyKey{}, &ExecutionInteraction{}, &OutboxMessage{},
	}
