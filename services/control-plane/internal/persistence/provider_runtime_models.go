...
type WorkerProviderManifest struct {
	...
	RuntimeAvailable                  bool           `gorm:"column:runtime_available"`
	RuntimeVersionSource              string         `gorm:"column:runtime_version_source"`
	RuntimeMinimumInclusive           string         `gorm:"column:runtime_minimum_inclusive"`
	RuntimeMaximumExclusive           *string        `gorm:"column:runtime_maximum_exclusive"`
	RuntimeCompatible                 bool           `gorm:"column:runtime_compatible"`
	ReleaseRequiresExplicitEnablement bool           `gorm:"column:release_requires_explicit_enablement"`
	ReleaseEnabled                    bool           `gorm:"column:release_enabled"`
