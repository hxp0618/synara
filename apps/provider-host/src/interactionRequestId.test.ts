...
describe("Provider interaction request IDs", () => {
  it("keeps long Codex native IDs bounded, stable, and Generation-scoped", () => {
    ...
    const generationSeven = providerInteractionRequestId(
      "codex",
      7,
      undefined,
      nativeId,
    );
    const sameGeneration = providerInteractionRequestId(
      "codex",
      7,
      undefined,
      nativeId,
    );
    const generationEight = providerInteractionRequestId(
      "codex",
      8,
      undefined,
      nativeId,
  ...
  it("preserves a deterministic Claude collision suffix inside the byte limit", () => {
    ...
    const original = providerInteractionRequestId(
      "claude",
      9,
      "approval",
      nativeId,
    );
    const duplicate = providerInteractionRequestId(
      "claude",
      9,
      "approval",
      nativeId,
