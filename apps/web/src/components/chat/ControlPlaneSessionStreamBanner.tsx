...
export const ControlPlaneSessionStreamBanner = memo(function ControlPlaneSessionStreamBanner({
  status,
}: {
  ...
  return (
    <DisclosureRegion open={open}>
      <ChatColumnBannerFrame>
        ...
        >
          <Icon
            className={cn(NOTIFICATION_ICON_CLASS_NAME, !unavailable && "motion-safe:animate-spin")}
          />
          <AlertTitle className="font-normal text-[var(--notification-fg)]">
            {unavailable ? "Session Event stream unavailable" : "Reconnecting to Session Events"}
          </AlertTitle>
