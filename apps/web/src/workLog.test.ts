...
describe("deriveWorkLogEntries", () => {
  ...
  it("preserves direct network and tool request kinds with readable titles", () => {
    const activities: OrchestrationThreadActivity[] = [
      makeActivity({
        id: "network-approval",
    ...
    expect(deriveWorkLogEntries(activities, undefined)).toMatchObject([
      { id: "network-approval", requestKind: "network", toolTitle: "Network access" },
      { id: "tool-approval", requestKind: "tool", toolTitle: "Tool call" },
    ]);
  });
